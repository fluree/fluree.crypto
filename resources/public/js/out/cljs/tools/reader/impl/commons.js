...
var G__21560 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__21560;
continue;
} else {
return ch;
...
var vec__21561 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__21561,(0),null);
return (match === s);
});
...
/** @this {Function} */
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq21564){
...
return (function() { 
var G__21569__delegate = function (rdr,_){
return cljs.tools.reader.impl.errors.reader_error.call(null,rdr,msg);
};
var G__21569 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__21570__i = 0, G__21570__a = new Array(arguments.length -  1);
while (G__21570__i < G__21570__a.length) {G__21570__a[G__21570__i] = arguments[G__21570__i + 1]; ++G__21570__i;}
  _ = new cljs.core.IndexedSeq(G__21570__a,0,null);
} 
return G__21569__delegate.call(this,rdr,_);};
G__21569.cljs$lang$maxFixedArity = 1;
G__21569.cljs$lang$applyTo = (function (arglist__21571){
var rdr = cljs.core.first(arglist__21571);
var _ = cljs.core.rest(arglist__21571);
return G__21569__delegate(rdr,_);
});
...
//# sourceMappingURL=commons.js.map?rel=1567785971902
