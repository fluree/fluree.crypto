...
return (new CustomEvent(event_name,(function (){var obj29855 = ({"detail":data});
return obj29855;
})()));
} else {
...
var f = (function (){var pred__29862 = cljs.core._EQ_;
var expr__29863 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__29862.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__29863))){
return ((function (pred__29862,expr__29863){
return (function (p1__29856_SHARP_){
return console.warn(p1__29856_SHARP_);
});
;})(pred__29862,expr__29863))
} else {
if(cljs.core.truth_(pred__29862.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__29863))){
return ((function (pred__29862,expr__29863){
return (function (p1__29857_SHARP_){
return console.debug(p1__29857_SHARP_);
});
;})(pred__29862,expr__29863))
} else {
if(cljs.core.truth_(pred__29862.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__29863))){
return ((function (pred__29862,expr__29863){
return (function (p1__29858_SHARP_){
return console.error(p1__29858_SHARP_);
});
;})(pred__29862,expr__29863))
} else {
return ((function (pred__29862,expr__29863){
return (function (p1__29859_SHARP_){
return console.log(p1__29859_SHARP_);
});
;})(pred__29862,expr__29863))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__29866){
...
var eval_fn = cljs.core.get.call(null,map__29867__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__29869_SHARP_);
});})(new_def))
);
...
return (function (p__29870){
var vec__29871 = p__29870;
var ky = cljs.core.nth.call(null,vec__29871,(0),null);
var v = cljs.core.nth.call(null,vec__29871,(1),null);
...
}catch (e29876){if((e29876 instanceof Error)){
var e = e29876;
return not_found;
} else {
throw e29876;
...
//# sourceMappingURL=utils.js.map?rel=1567785976991
